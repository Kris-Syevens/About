...
function finalGrade(grade: number, projectsCompleted: number): number {
  if (grade > 90 || projectsCompleted > 10) {
    return 100;
  } else if (grade > 75 && projectsCompleted >= 5) {
    return 90;
  } else if (grade > 50 && projectsCompleted >= 2) {
    return 75;
  } else return 0;
}
